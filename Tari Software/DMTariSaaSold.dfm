object DMTSaas: TDMTSaas
  ...
  object DetailedTargetsTbl: TIBOTable
    ColumnAttributes.Strings = (
      'DETAILED_TARGETS.BUSINESS_ID=REQUIRED'
      'DETAILED_TARGETS.ACCOUNT_ID=REQUIRED'
    ...
    MasterSource = DSMemberBusinesses
    TableName = 'DETAILED_TARGETS'
    FieldOptions = []
    Left = 56
    Top = 296
    object DetailedTargetsTblBUSINESS_ID: TIntegerField
      FieldName = 'BUSINESS_ID'
      Origin = 'DETAILED_TARGETS.BUSINESS_ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object DetailedTargetsTblACCOUNT_ID: TIntegerField
      FieldName = 'ACCOUNT_ID'
      Origin = 'DETAILED_TARGETS.ACCOUNT_ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object DetailedTargetsTblSTART_PERIOD: TSmallintField
      FieldName = 'START_PERIOD'
      Origin = 'DETAILED_TARGETS.START_PERIOD'
      Required = True
    end
    object DetailedTargetsTblBALANCES: TIBOArrayField
      FieldName = 'BALANCES'
      Origin = 'DETAILED_TARGETS.BALANCES'
    end
  end
  object DSDetailedTargets: TDataSource
    DataSet = DetailedTargetsTbl
    Left = 144
    Top = 296
  end
