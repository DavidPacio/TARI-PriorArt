...
{ Topics) which are located in Lok_onHlp.rtf     }
{                                                 }
{ This file is re-written by RoboHELP           }
{ whenever Lok_onHlp.rtf is saved.   	          }
{                                                 }
{ However, the numeric values stored in           }
{ Lok_onHlp.hh are the 'master values' and if you    }
{ modify the value in Lok_onHlp.hh and then          }
{ save the Lok_OnHlp.rtf again, this file will }
