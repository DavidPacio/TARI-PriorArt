...
uses
  ...
  Buttons, auchTypes, ChartHistory, Math, ChartManualDE,
  ...
  cxButtons, Businesssetup, Menus, DateUtils, cxGraphics, cxLookAndFeels,
  ...
  dxSkinWhiteprint, dxSkinXmas2008Blue, cxStyles, dxSkinscxPCPainter, cxFilter,
  cxData, cxTextEdit, cxCurrencyEdit, VCLTee.TeeEdit, VCLTee.TeEngine,
  VCLTee.TeeTools, VCLTee.TeePageNumTool, VCLTee.Series, VCLTee.TeeProcs,
  VCLTee.Chart, cxMaskEdit, cxSpinEdit, cxSpinButton;
...
procedure TDetailExpensesF.cxSpinButton1PropertiesEditValueChanged(
  Sender: TObject);
begin
