...
uses
  ...
  LicenceB in 'LicenceB.pas' {LicenceBF},
  DIYMainB in 'DIYMainB.pas' {DIYMainBF};
...
begin
  ...
  Application.CreateForm(TLicenceBF, LicenceBF);
  Application.CreateForm(TDIYMainBF, DIYMainBF);
  Application.Run;
  end
  else
