...
uses
  SysUtils, Classes, cxContainer, cxEdit, cxGridBandedTableView, cxClasses,
  cxStyles, cxGridTableView, cxExtEditRepositoryItems, cxGridCardView,
  ImgList, Controls, cxGraphics, dxSkinsCore, dxSkinBlack, dxSkinBlue,
...
type
  TDMRep1 = class(TDataModule)
    cxEditRepository1: TcxEditRepository;
    cxEditRepository1Label1WithWrap: TcxEditRepositoryLabel;
    AllStyles1: TcxStyleRepository;
    cxStyle1: TcxStyle;
    cxStyle2: TcxStyle;
    cxStyle3: TcxStyle;
    cxStyle4: TcxStyle;
    ...
    GridBandedTableViewStyleDexExpress: TcxGridBandedTableViewStyleSheet;
    CurrencyEditStyle: TcxEditStyleController;
    FooterCurrencyStyle: TcxEditStyleController;
    cxEditStyleLabelSmall: TcxEditStyleController;
    cxEditStyleLabelLarge: TcxEditStyleController;
    cxEditStyleControllerBackgroundColor: TcxEditStyleController;
    cxEditStyleController1: TcxEditStyleController;
    cxEditStyleLabelExtraLarge: TcxEditStyleController;
    LabelCentredNoWrap: TcxEditRepositoryLabel;
    LabelCentredNoWrapNoTransparent: TcxEditRepositoryLabel;
    LabelRightJustifiedTransparent: TcxEditRepositoryLabel;
    ...
    HotLargeImages: TImageList;
    DisabledLarge: TImageList;
    SmallImages: TImageList;
    TariButtonList: TcxImageList;
    ButtonGlyphList: TImageList;
