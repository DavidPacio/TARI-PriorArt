...
uses
  ...
  cxGroupBox, ActnList, cxMemo, cxRichEdit, cxDBLabel, dxSkinsCore, dxSkinBlack,
  ...
  cxLookAndFeels, cxLookAndFeelPainters, Menus, cxStyles, cxFilter, cxData,
  dxSkinBlueprint, dxSkinDevExpressDarkStyle, dxSkinDevExpressStyle,
  dxSkinHighContrast, dxSkinSevenClassic, dxSkinSharpPlus,
  dxSkinTheAsphaltWorld, dxSkinVS2010, dxSkinWhiteprint, cxFontNameComboBox,
  ...
  case Integer(ADataBinding.Data) of    //
    ...
    2:  begin
        if DataModuleClient.DateRangersD_Index.value > 0 then
          Result := PNLRec.PastBalances[DataModuleClient.DateRangersD_Index.value - 1]
        else
          Result := 0;
        end;
...
begin
  GGlobals.DebugOut('PastInfoPlan: Enter Past activity');
